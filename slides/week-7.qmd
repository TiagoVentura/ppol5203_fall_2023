...
# [Pandas Notebook Join and Tidy]("./_week-5c-joining_data.html")
...
- Here: cover the basics. 
  ...
  - introduce native Python libraries (`matplotlib` and `seaborn`)
...
```{r}
knitr::include_graphics("global_res_no_band.png")
```
...
```{r}
knitr::include_graphics("../lecture_notes/week-7/global_no_aes.png")
```
...
```{r}
knitr::include_graphics("../lecture_notes/week-7/global_color_to_distinguish.png")
```

## Color Aesthetics to Highlight

```{r}
knitr::include_graphics("../lecture_notes/week-7/global_color_to_highlight.png")
```
...
```{r}
knitr::include_graphics("../lecture_notes/week-7/global_color_to_values.png")
```
