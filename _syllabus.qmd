...
-   Office hours: Every Thursday, 4pm - 6pm
...
**Readings**: We will rely primarily on the following text for this course. No worries about buying these books. Most of them are available online.
...
-   For private questions concerning the class, email is the preferred method of communication. All email messages must originate from your Georgetown University email account(s). ***Please email the professor and the TA directly rather than through the Canvas messaging system.***
